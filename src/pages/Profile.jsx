...
import { doc , updateDoc, collection, getDocs, orderBy, query, where, deleteDoc} from 'firebase/firestore';
        ...
        <div className='w-full md:w-[50%] mt-6 px-3 '>
          <form>
            ...
            border border-gray-300 rounded transition ease-in-out ${
                changeDetail && "bg-pink-200 focus:bg-red-200"
              }`}/>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
              ...
              <p onClick={onLogout} className='text-blue-600 hover:text-blue-700 transition ease-in-out
