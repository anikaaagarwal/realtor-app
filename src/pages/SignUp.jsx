...
export default function Signup() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      toast.success('Hooray!! Sign Up was Successful');
      navigate('/')
    } catch (error) {
    ...
    <section> 
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src='https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=773&q=80' alt='key'
          ...
          <form onSubmit = {onSubmit}>
            ...
            text-sm sm:text-lg'>
              <p className='mb-6'>
                ...
                hover:text-red-800 transition duration-200 ease-in-out ml-1'>Sign In 
                </Link>
              </p>
              <p>
